package org.moara.yido.ner.test.recognizer;

import org.junit.jupiter.api.Assertions;
import org.junit.jupiter.api.Test;
import org.moara.yido.ner.*;
...
public class NamedEntityRecognizerTest {
    ...
    public void testSimpleTargetWord() {
        ...
        List<NamedEntity> answerList = Arrays.asList(new NamedEntity("박종우", "PS_REPORTER", 8, 11), new NamedEntity("김경목", "PS_REPORTER", 139, 142));
    ...
    public void testMultiEntity() {
        ...
        List<NamedEntity> answerList = Arrays.asList(new NamedEntity("이보람", "PS_REPORTER", 52, 55),
                new NamedEntity("안원준", "PS_REPORTER", 56, 59),
                new NamedEntity("장영태", "PS_REPORTER", 60, 63),
                new NamedEntity("김동욱", "PS_REPORTER", 64, 67));
        NamedEntity[] result = namedEntityRecognizer.recognize(text);
        ...
        answerList = Arrays.asList(new NamedEntity("최모란", "PS_REPORTER", 97, 100),
                new NamedEntity("최은경", "PS_REPORTER", 101, 104),
                new NamedEntity("심석용", "PS_REPORTER", 105, 108));
        ...
        answerList = Arrays.asList(new NamedEntity("김민상", "PS_REPORTER", 47, 50),
                new NamedEntity("박사라", "PS_REPORTER", 51, 54),
                new NamedEntity("박태인", "PS_REPORTER", 55, 58));
    ...
    public void testNoSpaceReporterRecognize() {
        ...
        NamedEntity answer = new NamedEntity("이태규", "PS_REPORTER", 36, 39);
        NamedEntity[] result = namedEntityRecognizer.recognize(text);
    ...
    public void testAdditionalWordsReporterRecognize() {
        ...
        NamedEntity answer = new NamedEntity("지환", "PS_REPORTER", 115, 117);
    ...
    public void testNoSpaceAtFront() {
        ...
        List<NamedEntity> answerList = Arrays.asList(new NamedEntity("강지원", "PS_REPORTER", 0, 3),
                new NamedEntity("강지원", "PS_REPORTER", 19, 22));
    ...
    public void testNearSplitWord() {
        ...
        List<NamedEntity> answerList = Arrays.asList(new NamedEntity("김유진", "PS_REPORTER", 68, 71));
