...
class PersonNamedEntityRecognizer implements NamedEntityRecognizer {
     ...
     */
    PersonNamedEntityRecognizer(String[] targetWords, String[] exceptionWords, String[] multipleSymbols, String entityType, BeginEnd entityLength) {
    ...
    public NamedEntity[] recognize(String text) {
        ...
        return personNamedEntities.stream()
    ...
    private List<NamedEntity> getEntities(String text, String targetWord) {
        ...
        while (targetIndex < text.length()) {
            ...
            for (String name : names) {
                ...
                NamedEntity personEntity = new NamedEntity(name, entityType, entityBegin - 1, entityEnd - 1);
