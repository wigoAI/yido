...
public class AnswerCheckerTest {
    ...
    public void setAnswerCheckerTest() {
        AnswerChecker answerChecker = AnswerChecker.setAnswerCheckerByAnswerFile("/data/data3Answer.txt");
    ...
    public void indexingTest() {
        String answer = "안녕하세요";
        String sheet = "안녕하세요 반갑습니다.";

        System.out.println(sheet.contains(answer));
        System.out.println(sheet.indexOf(answer) + answer.length());

        System.out.println(sheet.substring(sheet.indexOf(answer) + answer.length()));
        System.out.println("".length() == 0);
        System.out.println("역시 토끼정 본 점 답죠?ㅎㅅㅎ".length());
    ...
    @Test
    public void answerCheckerTestWithKkokkoma() throws Exception {
        ...
        String UseData = data[USED_CASE - 1];
        double timeAverage = 0;
        for(int i = 0 ; i < 1 ; i++) {
            long start = System.nanoTime();

            // analyze morpheme without any post processing
            List ret = ma.analyze(UseData);
            ...
            sheet = ma.divideToSentences(ret);
        ...
        // print the result
        List<String> sheetStr = new ArrayList<>();
        for( int i = 0; i < sheet.size(); i++ ) {
            Sentence st = (Sentence) sheet.get(i);
            System.out.println(st.getSentence());
            for(int j = 0 ; j < st.size() ; j++) {
                String efn = st.get(j).getLastMorp().getSmplStr();
                if(efn.contains("EFN"))
                    System.out.print("[" + efn + "]");
            }
            System.out.println();
            sheetStr.add(st.getSentence());
        }


        System.out.println(answerChecker.checkAnswer(sheetStr));
    }
    ...
    public void testBase() {
        ...
        String usedData = data[USED_CASE - 1];
        double timeAverage = 0;
        for(int i = 0 ; i < 10 ; i++) {
            long start = System.nanoTime();
            long end = System.nanoTime();
    ...
    public void oktTest() {
        ...
        for(int i = 0 ; i < 10 ; i++) {
            ...
            sentence = splitter.sentences(usedData);
        ...
        System.out.println(answerChecker.checkAnswer(sentence));
    }
    ...
    public void hnnTest() {
        ...
        for(int i = 0 ; i < 1 ; i++) {
            ...
            result = splitter.sentences(usedData);
