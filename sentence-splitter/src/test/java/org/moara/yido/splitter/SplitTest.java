...
public class SplitTest {
    ...
    public void useBasicSentenceSplitterSplitTest() {
        for(Sentence sentence : SentenceSplitterFactory.getInstance().split(data[0])) {
...
//            assertTrue( "Splitter accuracy is under than 50%", accuracy > 50);
    ...
    public void newsSentenceSplitTest() {
        SentenceSplitter sentenceSplitter = SentenceSplitterFactory.getInstance().getSentenceSplitter(2);

        for(Sentence sentence : sentenceSplitter.split(data[5])) {
            System.out.println(sentence.getText());
        }
    }
