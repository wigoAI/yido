...
public class RegularTest {
    ...
    public void findBracketTest() {
        ...
        while(bracketMatcher.find()) {
            ...
            System.out.println(bracketMatcher.group());
        }
