...
import org.yido.splitter.answer.AnswerChecker;
...
public class AnswerCheckerTest {
    ...
    public void setAnswerCheckerTest() {
        AnswerChecker answerChecker = AnswerChecker.setAnswerCheckerByAnswerFile("/data/data1Answer.txt");
...
//        answerList.add("강남 역 맛 집으로 소문난 강남 토끼 정에 다녀왔습니다.");
//        answerList.add("회사 동료 분들과 다녀왔는데 분위기도 좋고 음식도 맛있었어요");
//        answerList.add("다만, 강남 토끼 정이 강남 쉑쉑 버거 골목길로 쭉 올라가야 하는데 다들 쉑쉑버거의 유혹에 넘어갈 뻔 했답니다");
//        answerList.add("강남 역 맛 집 토끼정의 외부 모습.");
