package org.moara.splitter.regular;
...
import org.moara.splitter.processor.regularExpression.RegularExpressionProcessor;
...
public class RegularTest {
    ...
    public void testMetaRole() {
        ...
        List<Area> exceptionArea = otherExceptionAreaProcessor.find(inputData);

        assertEquals(834, exceptionArea.get(0).getStart());
        assertEquals(841, exceptionArea.get(0).getEnd());
        assertEquals(1045, exceptionArea.get(1).getStart());
        assertEquals(1085, exceptionArea.get(1).getEnd());
        assertEquals(1190, exceptionArea.get(2).getStart());
        assertEquals(1221, exceptionArea.get(2).getEnd());
