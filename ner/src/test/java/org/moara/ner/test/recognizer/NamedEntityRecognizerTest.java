...
public class NamedEntityRecognizerTest {
    ...
    public void testMultiEntity() {
        ...
        List<PersonEntity> answerList = Arrays.asList(new PersonEntity("이보람", "REPORTER", 52, 55),
                new PersonEntity("안원준", "REPORTER", 56, 59),
                new PersonEntity("장영태", "REPORTER", 60, 63),
                new PersonEntity("김동욱", "REPORTER", 64, 67));
        NamedEntity[] namedEntities = namedEntityRecognizer.recognize(text);
        ...
        namedEntityRecognizer = NamedEntityRecognizerManager.getInstance().getNamedEntityRecognizer("reporter");

        answerList = Arrays.asList(new PersonEntity("최모란", "REPORTER", 97, 100),
                new PersonEntity("최은경", "REPORTER", 101, 104),
                new PersonEntity("심석용", "REPORTER", 105, 108));
        ...
        answerList = Arrays.asList(new PersonEntity("김민상", "REPORTER", 47,50),
                new PersonEntity("박사라", "REPORTER", 51, 54),
                new PersonEntity("박태인", "REPORTER", 55, 58));
    ...
    public void testNoSpaceReporterRecognize() {
        ...
        PersonEntity answer = new PersonEntity("이태규", "REPORTER", 36, 39);
        NamedEntity[] namedEntities = namedEntityRecognizer.recognize(text);
    ...
    public void testAdditionalWordsReporterRecognize() {
        ...
        PersonEntity answer = new PersonEntity("지환", "REPORTER", 115, 117);
    ...
    public void testNoSpaceAtFront() {
        ...
        List<PersonEntity> answerList = Arrays.asList(new PersonEntity("강지원", "REPORTER", 0,3),
                new PersonEntity("강지원", "REPORTER", 19, 22));
