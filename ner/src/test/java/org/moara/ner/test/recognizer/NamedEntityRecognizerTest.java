...
public class NamedEntityRecognizerTest {
    ...
    public void testMultiEntity() {
        ...
        List<NamedEntity> answerList = Arrays.asList(new NamedEntityImpl("이보람", "PS_REPORTER", 52, 55),
        ...
        answerList = Arrays.asList(new NamedEntityImpl("최모란", "PS_REPORTER", 97, 100),
